                ...
                <div class="row">
                                        ...
                                        <div id="collapseOne" class="panel-collapse collapse in">
                                            <div class="panel-body">
                                                <div class="infoBoxContents">
                                                    <a href="Flucategory.php">Flu Category</a>&nbsp;(94)<br />
                                                    <a href="exzemaTreatment.php"> Eczema Treatment Category</a>&nbsp;(9)<br />
                                                    <a href="JointCategory.php">Joint Category</a>&nbsp;(5)<br />
                    ...
                    <div class="col-md-9 col-sm-8 col-xs-12" id="content">            
                        <div class="contentText">
                            ...
                            <h1>Dermarest Eczema Medicated Lotion Fragrance Free</h1>
                            <div class="row">
                                <div class="col-sm-2 col-xs-6"><img class="img-thumbnail"  src="images/unnamed (1).jpg"></div>
                                <div class="col-sm-10 col-xs-6"><p>
                                •  Temporary relieves itching <br>
                            ...
                            <div class="row margin-top product-layout_width">
                                <div class="product-layout product-grid col-lg-4 col-md-4 col-sm-6 col-xs-12">
                                    <div class="product-thumb">
                                        <div class="image"><a href="search_result.php?name=Aveeno Active Naturals Eczema Therapy Hand"><img class="img-responsive"  src="images/Aveeno-Eczema-Therapy-Hand-Cream-2.6oz.jpg" width="200" height="200"></a></div>
                                        <div>
                                            <div class="caption">
                                                <h4 class="product_title"><a href="search_result.php?name=Aveeno Active Naturals Eczema Therapy Hand">Aveeno Active Naturals Eczema Therapy Hand </a></h4>
                                                <p>
                                                •  Helps loosen phlegm <br>
                                                Helps Us To Recovery <br>
                                                Helps Us to Cookies <br>
                                                Helps Us TO RECVERY
•  Makes coughs more productive <br>
                                            ...
                                            <a class="btn book-btn btn-default reg_button" href="search_result.php?name=Aveeno Active Naturals Eczema Therapy Hand">BUY NOW!</a>
                                ...
                                <div class="product-layout product-grid col-lg-4 col-md-4 col-sm-6 col-xs-12">
                                    <div class="product-thumb">
                                        <div class="image"><a href="search_result.php?name= Natralia Eczema & Psoriasis Cream"><img class="img-responsive"  src="images/2_100 (2).jpg" width="200" height="200" ></a></div>
                                        <div>
                                            <div class="caption">
                                                <h4 class="product_title"><a href="search_result.php?name= Natralia Eczema & Psoriasis Cream"> Natralia Eczema & Psoriasis Cream</a></h4>
                                                <p>
                                                •  Relief of skin irritation <br>
•  Aids itching, redness, flaking & scaling
                                            ...
                                            <!--<div class="button-group">!-->
                                            <a class="btn book-btn btn-default reg_button" href="search_result.php?name= Natralia Eczema & Psoriasis Cream">BUY NOW!</a>
                                            <div class="pull-right">
                                                <button  title="" data-toggle="tooltip" type="button" class="btn wish_button btn-default reg_button"><i class="fa fa-heart"></i></button>
                                                <button  title="" data-toggle="tooltip" type="button" class="btn wish_button btn-default reg_button"><i class="fa fa-exchange"></i></button>
                                            </div>
                                ...
                                <div class="product-layout product-grid col-lg-4 col-md-4 col-sm-6 col-xs-12">
                                    <div class="product-thumb">
                                        <div class="image"><a href="search_result.php?name=Aveeno Eczema Care Itch Relief Balm"><img class="img-responsive"  src="images/unnamed.jpg" width="200" height="200" ></a></div>
                                        <div>
                                            <div class="caption">
                                                <h4 class="product_title"><a href="search_result.php?name=Aveeno Eczema Care Itch Relief Balm">Aveeno Eczema Care Itch Relief Balm</a></h4>
                                                <p>
    ...
    •  Pharmacist recommended
                                            ...
                                            <!--<div class="button-group">!-->
                                            <a class="btn book-btn btn-default reg_button" href="search_result.php?name=Aveeno Eczema Care Itch Relief Balm">BUY NOW!</a>
                                            <div class="pull-right">
                                                <button  title="" data-toggle="tooltip" type="button" class="btn wish_button btn-default reg_button"><i class="fa fa-heart"></i></button>
                                                <button  title="" data-toggle="tooltip" type="button" class="btn wish_button btn-default reg_button"><i class="fa fa-exchange"></i></button>
                                            </div>
                                ...
                                <div class="product-layout product-grid col-lg-4 col-md-4 col-sm-6 col-xs-12">
                                    <div class="product-thumb">
                                        <div class="image"><a href="search_result.php?name=Walgreens Wal-Tussin Chest Congestion"><img class="img-responsive"  src="images/download.jpg" width="100" height="100" ></a></div>
                                        <div>
                                            <div class="caption">
