                ...
                <div class="row">
                    ...
                    <div class="col-md-9 col-sm-8 col-xs-12" id="content">            
                        <div class="contentText">
                            ...
                            <h1>BIOFREEZE Classic Pain Relieving Roll-On</h1>
                            <div class="row">
                                <div class="col-sm-2 col-xs-6"><img class="img-thumbnail"  src="images/GUEST_b8e82f6b-e0d9-4dde-a745-5224e6af575d.jpg"></div>
                            ...
                            <div class="row margin-top product-layout_width">
                                <div class="product-layout product-grid col-lg-4 col-md-4 col-sm-6 col-xs-12">
                                    <div class="product-thumb">
                                        <div class="image"><a href="search_result.php?name=Boiron Arnicare Pain Relieving Arnica Gel"><img class="img-responsive"  src="images/Arnica-Pain-Relief-Gel.jpg" width="200" height="200"></a></div>
                                        <div>
                                            <div class="caption">
                                <h4 class="product_title"><a href="search_result.php?name=Boiron Arnicare Pain Relieving Arnica Gel">Boiron Arnicare Pain Relieving Arnica Gel</a></h4>
                                                <p>
...
•  Makes coughs more productive <br>
                                            ...
                                            <a class="btn book-btn btn-default reg_button" href="search_result.php?name=Boiron Arnicare Pain Relieving Arnica Gel">BUY NOW!</a>
                                ...
                                <div class="product-layout product-grid col-lg-4 col-md-4 col-sm-6 col-xs-12">
                                    <div class="product-thumb">
                                        <div class="image"><a href="search_result.php?name=Natralia Eczema & Psoriasis Cream"><img class="img-responsive"  src="images/91fgK2IAINL._SY355_.jpg" width="200" height="200" ></a></div>
                                        <div>
                                            <div class="caption">
...
•  Aids itching, redness, flaking & scaling
                                ...
                                <div class="product-layout product-grid col-lg-4 col-md-4 col-sm-6 col-xs-12">
                                    <div class="product-thumb">
                                        <div class="image"><a href="search_result.php?name=Aveeno Eczema Care Itch Relief Balm"><img class="img-responsive"  src="images/aspercreme-odor-free-therapy.jpg" width="200" height="200" ></a></div>
                                        <div>
                                            <div class="caption">
