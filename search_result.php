...
<html lang="en">
    ...
    <body>
            ...
            // print_r($_SESSION);
                ...
                if(isset($row
                                            ...
                                            <table border="0"   width="80%" bgcolor="#ffffff">
                                                ...
                                                <img src="images/general3.png"  width="130px">
                                       ...
                                       echo '<td style="background-color:white"> <a href="cart_processes.php?name='.$row['name'].'&cat_name='.$row['cat_name'].'&price='.$row['price'].'">
        ...
        echo '<td style="background-color:white"><img src="images/add-to-cart.png" width=55px;height=60px><br><a href="login.php"> <h4>Please Login..</h4></a></td>';
                ...
                echo'<tr>';
                echo'<td>';
                echo "<h4 style='color: gray ;text-align: center;margin-top: 5%'>Sorry :( this Medicine is not avilable now</h4>";
                echo'</td>';
                echo '</tr>';
                }
