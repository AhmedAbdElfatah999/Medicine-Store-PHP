...
$query="INSERT INTO `user` (`id`, `password`, `username`, `phone`, `type`, `fullname`) VALUES (NULL, '$newpassword', '$user_name', '$phone', '2', '$fname.$lname')";
                        ...
                        <input type="text" class="form-control" id="input-username" placeholder="user name" value="" name="user_name"  required>
                                ...
                                <div class="buttons">
                                    <div class="pull-right">I have read and agree to the <a class="agree" href="#"><b>Privacy Policy</b></a>                                                        <input type="checkbox" value="1" name="agree">
                                        ...
                                        <a href="notification.php?&first_name="<?php echo $_SESSION['user_name'];?>>
